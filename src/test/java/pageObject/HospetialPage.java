...
public class HospetialPage extends BaseClass {
	...
	public void filterHospetial() {
		...
		System.out.println();
		System.out.println();
		System.out.println("------- Hospetial opened 24/7, having Parking fecility and having ratings more than 3.5 --------");
